...
from blog_posts_extra import BLOG_POSTS_EXTRA
from blog_posts_iqos_base import BLOG_POSTS_IQOS, LEGACY_SHARED_BLOG_SLUGS
from app import app
...
ALL_BLOG_POSTS = BLOG_POSTS_IQOS + BLOG_POSTS_EXTRA

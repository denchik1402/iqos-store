...
def home_faq_items(brand: str, city: str = 'Москва') -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            'a': (
                'Доставка платная: от 0 ₽, точная стоимость зависит от адреса. '
                'По Москве и МО курьер обычно в день заказа или на следующий (до 14:00 — часто сегодня). '
                'По России — от 1–2 дней; сумму и сроки менеджер сообщит при подтверждении брони.'
            ),
        },
    ]
